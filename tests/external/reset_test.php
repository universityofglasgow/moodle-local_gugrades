...
class reset_test extends \local_gugrades\external\gugrades_advanced_testcase {
    ...
    public function test_reset() {
        ...
        \local_gugrades\api::import_grade($this->course->id, $this->gradeitemidassign1, $conversion, $activity, $studentid, false);
        ...
        \local_gugrades\api::import_grade($this->course->id, $this->gradeitemidassign2, $conversion, $activity, $studentid, false);
